...
addFilter('blocks.registerBlockType', 'itmar_core_customize/add_block_design_attr', addBtnDesignAttributes);

//選択されたブロックがcore/buttonだったらサードバーに新しい設定メニューを追加
const addBtnDesignCtrl = createHigherOrderComponent(BlockEdit => {
  return props => {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcore_customize"] = self["webpackChunkcore_customize"] || [];
